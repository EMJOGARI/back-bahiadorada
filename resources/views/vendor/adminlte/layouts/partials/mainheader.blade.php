...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
       ...
       {{-- <!-- mini logo for sidebar mini 50x50 pixels -->
        ...
        <span class="logo-lg"><b>TRADE</b>GO</span>--}}
    </a>
                    ...
                    <li class="dropdown user user-menu" id="user_menu" style="max-width: 280px;white-space: nowrap;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{ url('/img/silueta.png') }}{{-- Gravatar::get($user->email) --}}" class="img-circle" alt="User Image" />
                                <p>
                            ...
                            <li class="user-footer">
                                @can('user.profile.update')
                                    <div class="pull-left">
                                        <a href="{{ route('usuarios.profile.edit',['id' => encrypt(Auth::user()->id)]) }}" class="btn btn-default btn-flat">{{ trans('adminlte_lang::message.profile') }}</a>
                                    </div>
                                @endcan
